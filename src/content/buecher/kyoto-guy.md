...
#
# OFFEN: der Umschlag. Solange kein `cover_bild` da ist, malt das Regal den
# Band aus den Farben unten — das sieht aus wie ein Buch und stoert nicht.
# Die Farben sind vorlaeufig geraten und gehoeren aus dem Umschlag genommen,
# sobald er da ist (siehe „Farben und Schriften" in AGENTS.md).
titel: The Kyoto Guy
...
rueckseite:
  ...
  klappentext: >-
    ...
    kauft ihm sein letztes Werk ab. Es ist kein Buch, sondern ein Parfum —
    und eine Note verrät der Alte nicht.
  zitat: >-
...
Ein Band, zwei Vorderseiten. Vorn „The Kyoto Guy" von Christoph Laible —
Gion, ein Club, ein altes Foto und die Wochen danach, in datierten
Einträgen. Gewendet: „Opium" von C. T. Selters — Wien, Kunming, Zhongdian,
